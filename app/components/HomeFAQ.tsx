...
export const homeFAQItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'No. GIF creation happens locally in your browser, so YTgify does not upload the video or finished GIF to a conversion server.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'The current Chrome release is distributed as a ZIP. After extracting it, enable Developer mode on the Chrome extensions page and load the extracted folder as an unpacked extension.',
  },
];
    ...
    >
      <div className="mb-8 max-w-2xl">
        ...
        <p className="mt-4 leading-relaxed text-gray-400">
          The short version of how YTgify works, what it costs, and what happens to your video.
        </p>
      </div>
      <div className="grid gap-3 lg:grid-cols-2">
        {homeFAQItems.map((item) => (
          <details
            key={item.question}
            className="group border border-gray-800 bg-gray-950/50 p-5 open:border-[#E91E8C]/40"
          >
