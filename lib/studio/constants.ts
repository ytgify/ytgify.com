import type { StudioFps, StudioResolution, StudioSizeTarget } from './types';

export const STUDIO_MAX_FILE_SIZE_BYTES = 250 * 1024 * 1024;
export const STUDIO_MAX_SOURCE_DURATION_SECONDS = 30 * 60;
...
export const STUDIO_SIZE_TARGETS: StudioSizeTarget[] = ['auto', 5, 10, 25];
