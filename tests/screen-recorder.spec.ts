...
test('recorder denial recovers without automatically requesting permission', async ({ page }) => {
...
test('real MediaRecorder canvas recording is finalized, trimmed and exported to GIF', async ({ page }, info) => {
